...
import logoicon1 from '@/public/bot.png'
                  ...
                  {showRetryInput && !hasReachedRetryLimit && (
                    <div className="flex items-center gap-1 ml-2 min-w-[200px]">
                      ...
                      <Button
                        ...
                        className="h-8 w-8 hover:bg-[#d09027]/10"
                      >
                        <IconClose className="text-[#d09027] h-3 w-3" />
                      </Button>
                    </div>
                  )}
                  {hasReachedRetryLimit && (
                    <div className="ml-2 px-2 py-1 bg-[#d09027]/10 border border-[#d09027]/20 rounded text-xs text-[#d09027]">
